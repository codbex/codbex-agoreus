...
var dao = require("agoreus-app/gen/dao/Nomenclatures/QuotationStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/agoreus-app/gen/api/QuotationStatus.js/" + entity.Id);
