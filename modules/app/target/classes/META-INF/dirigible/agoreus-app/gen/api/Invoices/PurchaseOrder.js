...
var dao = require("agoreus-app/gen/dao/Invoices/PurchaseOrder");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/agoreus-app/gen/api/PurchaseOrder.js/" + entity.Id);
