...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'agoreus-app.Nomenclatures.OfferStatus.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('agoreus-app.Nomenclatures.OfferStatus.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/agoreus-app/gen/api/Nomenclatures/OfferStatus.js';
