...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'agoreus-app.Partners.Partner.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('agoreus-app.Partners.Partner.refresh', callback);
		},
		onCountryModified: function(callback) {
			on('agoreus-app.Partners.Country.modified', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/agoreus-app/gen/api/Partners/Partner.js';
