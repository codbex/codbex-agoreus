...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'agoreus-app.Partners.Trader.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('agoreus-app.Partners.Trader.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/agoreus-app/gen/api/Partners/Trader.js';
