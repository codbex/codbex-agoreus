...
const dao = require("codbex-agoreus/gen/dao/entities/OfferStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-agoreus/gen/api/OfferStatus.js/" + entity.Id);
