...
const dao = require("codbex-agoreus/gen/dao/entities/SalesOrder");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-agoreus/gen/api/SalesOrder.js/" + entity.Id);
