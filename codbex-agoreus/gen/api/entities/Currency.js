...
const dao = require("codbex-agoreus/gen/dao/entities/Currency");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-agoreus/gen/api/Currency.js/" + entity.Code);
